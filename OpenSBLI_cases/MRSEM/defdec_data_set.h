...
int base[] = {0, 0, 0};
double* value = NULL;
rhohou0u0_mean_B0 = ops_decl_dat(opensbliblock00, 1, size, base, halo_m, halo_p, value, "double", "rhohou0u0_mean_B0");
}
ops_dat rhou0_B0;
{
if (restart == 1){
...
int halo_m[] = {0,0,0};
int base[] = {0,0,0};
int size[] = {eddies[0], 1, 1};
double* value = NULL;
eddy_pos1 = ops_decl_dat(opensbliblock00, 3, size, base, halo_m, halo_p, value, "double", "eddy_pos1");
}
ops_dat eddy_r1;
{
int halo_p[] = {0,0,0};
...
int size[] = {eddies[0], 1, 1};
double* value = NULL;
eddy_r1 = ops_decl_dat(opensbliblock00, 3, size, base, halo_m, halo_p, value, "double", "eddy_r1");
}
ops_dat eddy_eps1;
{
int halo_p[] = {0,0,0};
...
int size[] = {eddies[0],1,1};
int* value = NULL;
eddy_eps1 = ops_decl_dat(opensbliblock00, 3, size, base, halo_m, halo_p, value, "int", "eddy_eps1");
}
ops_dat eddy_pos2;
{
int halo_p[] = {0,0,0};
int halo_m[] = {0,0,0};
int base[] = {0,0,0};
int size[] = {eddies[1], 1, 1};
double* value = NULL;
eddy_pos2 = ops_decl_dat(opensbliblock00, 3, size, base, halo_m, halo_p, value, "double", "eddy_pos2");
}
ops_dat eddy_r2;
{
int halo_p[] = {0,0,0};
...
int size[] = {eddies[1], 1, 1};
double* value = NULL;
eddy_r2 = ops_decl_dat(opensbliblock00, 3, size, base, halo_m, halo_p, value, "double", "eddy_r2");
}
ops_dat eddy_eps2;
{
int halo_p[] = {0,0,0};
...
int size[] = {eddies[1],1,1};
int* value = NULL;
eddy_eps2 = ops_decl_dat(opensbliblock00, 3, size, base, halo_m, halo_p, value, "int", "eddy_eps2");
}
ops_dat eddy_pos3;
{
int halo_p[] = {0,0,0};
int halo_m[] = {0,0,0};
int base[] = {0,0,0};
int size[] = {eddies[2], 1, 1};
double* value = NULL;
eddy_pos3 = ops_decl_dat(opensbliblock00, 3, size, base, halo_m, halo_p, value, "double", "eddy_pos3");
}
ops_dat eddy_r3;
{
int halo_p[] = {0,0,0};
...
int size[] = {eddies[2], 1, 1};
double* value = NULL;
eddy_r3 = ops_decl_dat(opensbliblock00, 3, size, base, halo_m, halo_p, value, "double", "eddy_r3");
}
ops_dat eddy_eps3;
{
int halo_p[] = {0,0,0};
...
int size[] = {eddies[2],1,1};
int* value = NULL;
eddy_eps3 = ops_decl_dat(opensbliblock00, 3, size, base, halo_m, halo_p, value, "int", "eddy_eps3");
}
...
int size[] = {eddies[0],1,1};
int* value = NULL;
bulk_rng1 = ops_decl_dat(opensbliblock00, 6, size, base, halo_p, halo_m, value, "int", "bulk_rng1");
}
ops_dat bulk_rng2;
{
int halo_p[] = {0,0,0};
...
int size[] = {eddies[1],1,1};
int* value = NULL;
bulk_rng2 = ops_decl_dat(opensbliblock00, 6, size, base, halo_p, halo_m, value, "int", "bulk_rng2");
}
ops_dat bulk_rng3;
{
int halo_p[] = {0,0,0};
...
int size[] = {eddies[2],1,1};
int* value = NULL;
bulk_rng3 = ops_decl_dat(opensbliblock00, 6, size, base, halo_p, halo_m, value, "int", "bulk_rng3");
}
