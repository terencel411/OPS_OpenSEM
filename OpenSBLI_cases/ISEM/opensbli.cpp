...
rng_minval = 0.05;
powfact = 0.5;
vsf = 5.0 * sqrt(2.0/3.0) * 0.5;
rng_sf = pow(rng_minval, 1.0/powfact);
rng_shift = (1.0+rng_sf)/(1.0-rng_sf);
rng_divfact = rng_shift+1.0;
...
delta = 11.6973525411;
radius = 0.2 * delta;
eddy_r_max = 0.41 * delta;
eddy_x_min = -eddy_r_max;
eddy_x_max = eddy_r_max;
eddy_y_min = 0.0;
eddy_y_max = delta + eddy_r_max;
eddy_z_min = -eddy_r_max;
eddy_z_max = 40.0 + eddy_r_max;
eddy_vol = std::abs((eddy_x_max - eddy_x_min) * (eddy_y_max - eddy_y_min) * (eddy_z_max - eddy_z_min));
eddies = trunc(4*eddy_vol/(radius*radius*radius));
eddiesm2 = 2 * eddies;
...
ops_decl_const("rng_shift", 1, "double", &rng_shift);
ops_decl_const("rng_divfact", 1, "double", &rng_divfact);
...
ops_decl_const("eddy_r_max", 1, "double", &eddy_r_max);
...
ops_arg_dat(eddy_z, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(eddy_r, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(eddy_increment, 1, stencil_0_00_00_00_3, "double", OPS_RW),
ops_arg_dat(eddy_eps_x, 1, stencil_0_00_00_00_3, "int", OPS_WRITE),
ops_arg_dat(eddy_eps_y, 1, stencil_0_00_00_00_3, "int", OPS_WRITE),
ops_arg_dat(eddy_eps_z, 1, stencil_0_00_00_00_3, "int", OPS_WRITE),
ops_arg_dat(eddy_bulk_rng, 5, stencil_0_00_00_00_3, "int", OPS_READ));
